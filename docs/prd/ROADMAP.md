...
> 最後更新：2026-03-12（Sprint 90 完成 — Systematic Debugging 三觸發點 + Deploy 通知模板與 Deploy Board）
> 擁有者：Product Owner
...
每個 Sprint 完成後 minor bump（v0.4.0, v0.5.0...），直到達成 v1.0.0 條件。目前版本：**v0.64.0**（Sprint 90）。
