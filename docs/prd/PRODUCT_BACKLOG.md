...
**最後更新**：2026-03-02（Sprint 20 Planning — Retro #56/57、US-31 選入 Sprint）
**管理者**：Product Owner
...
| 3 | US-31（Issue #47）：/shoot 短衝模式 | 待定 | Should | L | Sprint 17 Retro / Issue #47 | In Sprint（Sprint 20；Architect 調升 Size 為 L / 3pt） |
...
| 排序 | Story | RICE | MoSCoW | Size | 來源 | 狀態 |
|------|-------|------|--------|------|------|------|
| 1 | Retro #56（Issue #56）：修復 test-schedule.sh assert_contains SIGPIPE 非確定性失敗 | — | Must | S | Sprint 19 Retro / Issue #56 | In Sprint（Sprint 20） |
| 2 | Retro #57（Issue #57）：Developer subagent 狀態更新衝突防護 | — | Must | S | Sprint 19 Retro / Issue #57 | In Sprint（Sprint 20） |
