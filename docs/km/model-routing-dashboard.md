...
> 最後更新：2026-03-26 13:53:30
> 資料範圍：最近 10 個 Sprint（Sprint 159 160 161 162 163 164 165 166 167 168）

## Tier 分布

| Tier | Model | 路由次數 | 比例 | 適用分數範圍 |
|------|-------|---------|------|------------|
| Tier 1 | haiku | 16 | 33% | 4–6 |
| Tier 2 | sonnet | 32 | 66% | 7–9 |
...
> **[ROUTING-OK]** haiku tier 比例 33% >= 30%，路由分布正常
