...
| US-21：真實制衡案例文件 | 新建 `docs/km/ROLE_BALANCE_CASES.md`（4+ 案例）+ README 連結 + sprint-review 提示 | Developer | 待開始 |
| US-18：Sprint Execution Issue 回覆自動化 | sprint-execution SKILL.md 新增 Issue 快掃子步驟 + label 狀態追蹤機制 | Developer + Architect | 待開始 |
| US-20：輕量 Bypass 機制 | scrum-master SKILL.md 新增 Bypass 定義 + Hard Gate 豁免條款 | Developer + Architect | 待開始 |
