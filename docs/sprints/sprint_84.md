...
|----------|------|------|--------|------|
| US-221 | 知識老化偵測 — API 文件更新主動感知與 ground truth 保鮮機制 | M | 2 | 待開始 |
| US-226 | SBE 範例體系 — Given/When/Then 結構化業務規則範例 | M | 2 | 待開始 |
| US-227 | 兩層索引機制 — Context 管理的 meta-index 漸進載入策略 | S | 1 | 待開始 |
| US-228 | Quality Observer — 獨立品質觀察角色與系統性診斷報告 | M | 2 | 待開始 |
