...
|-------|-------|------|------|--------|------|----------|--------|
| feat: Sprint Planning Pre-flight Backlog 健康度檢查 | #656 | FEAT | S | 1 | TODO | Developer | Group A (Wave 1) |
| retro: 評估 #657 是否與 #652 重複，決定關閉或縮小範疇 | #661 | RETRO | S | 1 | TODO | PO | Group B (Wave 2) |
| chore: 清除 new-issue-intake.yml 殘留引用 | #662 | CHORE | S | 1 | TODO | Developer | Group A (Wave 1) |
