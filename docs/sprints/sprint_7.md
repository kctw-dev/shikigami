...
| US-T05：交叉引用驗證 | 新建 `scripts/validate-xrefs.sh`，掃描所有 .md 的 shikigami:xxx 引用並驗證對應 skill 存在 | Developer + QA | 完成 |
| US-T07：CI Pipeline | 新建 `.github/workflows/validate.yml`，自動執行所有驗證腳本 | Developer + QA | 完成 |
