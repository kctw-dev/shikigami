...
|-------|-------|------|------|--------|------|----------|--------|
| retro: 驗證 validate-skills.sh 覆蓋完整性 | #667 | RETRO | S | 1 | TODO | Developer | Wave 1（獨立） |
| feat: TDAD 依賴分析可透過設定關閉 | #653 | FEAT | S | 1 | TODO | Developer | Wave 1（獨立） |
| chore: ADR index 修復 263 WARNING | #655 | CHORE | M | 3 | TODO | Developer | Wave 1（獨立） |
